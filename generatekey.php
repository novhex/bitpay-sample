...
$privateKey = \Bitpay\PrivateKey::create('tmp/api.key')->generate();
 ...
 */
$publicKey = new \Bitpay\PublicKey('tmp/api.pub');
 ...
 */
$storageEngine = new \Bitpay\Storage\EncryptedFilesystemStorage('wow_magic**123');
